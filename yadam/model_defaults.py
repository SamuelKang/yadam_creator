DEFAULT_TEXT_LLM_MODEL = "gemini-2.0-flash"
...
GEMINI_IMAGE_MODEL_FALLBACKS = {
    # user shorthand / typo aliases
    "gemini": DEFAULT_GEMINI_IMAGE_MODEL,
    "gemini_flash": DEFAULT_GEMINI_IMAGE_MODEL,
    "gemini-2.5-flash": DEFAULT_GEMINI_IMAGE_MODEL,
    "gemini-2.5-flash-imag": DEFAULT_GEMINI_IMAGE_MODEL,
